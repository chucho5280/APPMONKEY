...
class MetodosPagos extends StatelessWidget {
                ...
                Container(
                  ...
                  child: ElevatedButton(
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        mainAxisAlignment:
                                            MainAxisAlignment.spaceBetween,
                                        children: [
                                          Text("Puedes eliminar esta tarjeta"),
                                          Switch(
                                            value: false,
                                            onChanged: (_) {},
                                            thumbColor:
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(Icons.add),
                          Text("Agregar otra tarjeta de crédito/débito"),
                        ],
                      )),
                )
              ],
